...
load_from = '/home/limingda/YOLO-World/weights/yolo_world_v2_x_obj365v1_goldg_cc3mlite_pretrain_1280ft-14996a36.pth'
log_level = 'INFO'
...
model = dict(
    backbone=dict(
        ...
        text_model=dict(
            ...
            model_name=
            '/home/limingda/YOLO-World/weights/clip-vit-base-patch32',
